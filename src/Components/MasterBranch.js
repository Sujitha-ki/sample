        ...
        >
          <div className="form-container">
            ...
            <div className="form-row">
              ...
              <div className="form-item">
                <p className="label">Branch Alias name</p>
                <Form.Item
                  name="branchAliasName"
                  rules={[
                    {
                      required: true,
                      message: "Please input your branch alias!",
                    },
                  ]}
                >
                  <Input className="input-field" />
              ...
              <div className="form-item">
                <p className="label">Branch Register Number</p>
                <Form.Item
                  name="branchRegisterNo"
                  rules={[
                    {
                      required: true,
                      message: "Please input your branchregister number!",
                    },
                  ]}
                >
                  <Input className="input-field" />
