...
//                   ]}
//                 >
//                   <Input placeholder="Company Code" className="input-field" />
//                 </Form.Item>
//               </div>
//             </div>
//             {/* Second Row */}
...
//                   ]}
//                 >
//                   <Input placeholder="GST Number" className="input-field" />
//                 </Form.Item>
//               </div>
//               <div className="form-item">
...
//                   ]}
//                 >
//                   <Input placeholder="PAN Number" className="input-field" />
//                 </Form.Item>
//               </div>
//               <div className="form-item">
...
//                   ]}
//                 >
//                   <Input placeholder="Email Id" className="input-field" />
//                 </Form.Item>
//               </div>
//             </div>
//             {/* Third Row */}
...
//                   ]}
//                 >
//                   <Input placeholder="Address Line 2" className="input-field" />
//                 </Form.Item>
//               </div>
...
//                   ]}
//                 >
//                   <Input placeholder="Address Line 3" className="input-field" />
//                 </Form.Item>
//               </div>
...
//                   ]}
//                 >
//                   <Input placeholder="Contact Person" className="input-field" />
//                 </Form.Item>
//               </div>
//             </div>
//             {/* Fifth Row */}
...
//   );
// }
// if 8 data items are there and selected 10 items in show rows it must display first 5 in page 1 and remaining 3 in page 2
import React, { useEffect, useState } from "react";
import {
  Form,
  Input,
...
export default function MasterCompany() {
  ...
  const [form] = Form.useForm();
  const [currentRecord, setCurrentRecord] = useState(null);
  const [itemsPerPage, setItemsPerPage] = useState(5); // Set initial rows per page
